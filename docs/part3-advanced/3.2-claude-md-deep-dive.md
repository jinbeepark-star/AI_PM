---
chapter: "3.2"
title: "CLAUDE.md 심화: PM 워크스페이스 설계"
...
> **본 챕터의 위치**:
>
> - 본 챕터 (3.2) — CLAUDE.md 의 전체 그림과 PM 워크스페이스 설계 (8축 프레임워크).
> - 챕터 [3.2.1 패턴 카탈로그](./3.2.1-claude-md-patterns.md) — mono / multi-folder / layered 배치 패턴.
> - 챕터 [3.2.2 4.7 시대의 CLAUDE.md](./3.2.2-claude-md-for-4-7.md) — literal following 대응 작성법 + 마이그레이션 체크리스트.
>
> 본 레포 루트의 [`/CLAUDE.md`](../../CLAUDE.md) 가 8축의 worked example 입니다.

## 왜 CLAUDE.md가 PM의 가장 중요한 파일인가

기본편(2.3 프로젝트 메모리)에서 메모리 계층 구조를 배웠다면, 이제 실전으로 들어간다.
